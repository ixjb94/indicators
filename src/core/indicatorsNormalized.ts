...
export class IndicatorsNormalized {
	 ...
	 * @returns 
	 */
	async crossany(a: any, b: any, size: number = a.length) {
	 ...
	 * @returns 
	 */
	async crossover(a: any, b: any, size: number = a.length) {
	 ...
	 * @returns 
	 */
	async hma(input: number[], period: number, size=input.length) {
	...
	async abands(
		...
		let upper_band: number[] = []
		let lower_band: number[] = []
		let middle_point: number[] = []
	 ...
	 * @returns 
	 */
	async copp(data: number[], period1: number, period2: number) {
